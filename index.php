...
<nav class="navbar bg-body-tertiary" data-bs-theme="dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#">
      <img src="/assets/hackers-poulette-logo.png" alt="Logo" width="150" height="75" class="d-inline-block align-text-top">
      Hackers-poulette
    </a>
  </div>
</nav>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !empty($_POST)) {
    ...
    if (!$has_error) {
        ...
        $mail->SMTPAuth = true;
        $mail->Username = "shavuk97@gmail.com"; // Modifica con il tuo indirizzo email
        $mail->Password = "ldutybnxvidlasng"; // Modifica con la tua password
        $mail->SMTPSecure = "ssl";
        $mail->Port = 465;
...
<main class="container my-5 text-center" style = "max-width: 580px">
<form method="post" action="" autocomplete="off">
    <label class="form-label" for="fname">First name:</label>
    <input class="form-control" type="text" id="fname" name="fname" value="<?php echo isset($_POST['fname']) ? htmlspecialchars($_POST['fname']) : ''; ?>"><br><br>
    <p class="error error_fname"><?php echo $fname_error; ?></p>

    <label class="form-label" for="lname">Last name:</label>
    <input class="form-control" type="text" id="lname" name="lname" value="<?php echo isset($_POST['lname']) ? htmlspecialchars($_POST['lname']) : ''; ?>"><br><br>
    <p class="error error_lname"><?php echo $lname_error; ?></p>

    <label class="form-label" for="email">Email:</label>
    <input class="form-control" type="email" id="email" name="email" value="<?php echo isset($_POST['email']) ? htmlspecialchars($_POST['email']) : ''; ?>"><br><br>
    ...
    <textarea id="message" name="message"><?php echo isset($_POST['message']) ? htmlspecialchars($_POST['message']) : ''; ?></textarea><br><br>
